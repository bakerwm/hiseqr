...
if(! is_hiseq_multiple_dir(input_dir)) {
  stop(paste0("Not a multiple ATACseq directory, _rx: ", input_dir))
}
```
...
df_report_list <- sapply(merge_list, list_hiseq_report) %>% unlist %>% unique()
...
## enrich
png_list <- lapply(merge_list, function(i){
  data.frame(

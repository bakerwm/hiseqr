...
```{r figure1_trim_reads, fig.height=5, fig.width=6}
plot_hiseq_trim(input_dir)
```

+ Map percentage

```{r figure1_align_reads, fig.height=5, fig.width=6}
plot_hiseq_align(input_dir, columns = c("map", "chrM", "spikein", "unmap"))
```

+ Unique percentage

```{r figure1_unique_reads, fig.height=5, fig.width=6}
...
```{r figure2_peaks, fig.height=5, fig.width=6}
...
```{r figure3_fragment_length, fig.height=5, fig.width=8}
...
hm_list <- purrr::keep(hm_list, function(i) is_hiseq_dir(dirname(dirname(i)), "rn"))
if(length(hm_list) > 0) {
...
pca_list <- purrr::keep(pca_list, function(i) is_hiseq_dir(dirname(dirname(i)), "rn"))

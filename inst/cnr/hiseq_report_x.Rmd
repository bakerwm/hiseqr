...
input_dir  <- "/data/yulab/wangming/work/devel_pipeline/hiseq/cnr/results/fruitfly_v1/CUT_and_RUN_Piwi_RNAi_embryo_3_4h_H3K4me3.vs.CUT_and_RUN_Piwi_RNAi_embryo_3_4h_IgG/"
...
hm_list <- purrr::keep(hm_list, function(i) is_hiseq_dir(dirname(dirname(i)), "rx"))
...
pca_list <- purrr::keep(pca_list, function(i) is_hiseq_dir(dirname(dirname(i)), "rx"))

...
deseq_dir <- "/data/yulab/wangming/work/yu_2020/projects/20200629_lxh_RNAseq/results/RNAseq_read1/RNAseq_nos_DaGal4XshWhite_6h.vs.RNAseq_nos_DaGal4XshPiwi1_6h/"
...
```{r, fig.width=5, fig.height=4}
get_plot(deseq_dir, "piRNA_cluster", 1)
```

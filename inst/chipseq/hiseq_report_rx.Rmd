...
```{r figure1_trim_reads, fig.height=4, fig.width=6}
...
```{r figure1_align_reads, fig.height=4, fig.width=6}
...
```{r unique_multi_reads, fig.height=4, fig.width=6}
...
```{r pcr_dup_reads, fig.height=4, fig.width=6}
